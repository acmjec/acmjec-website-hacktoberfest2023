  ...
  return (
    <>
      <div className="bg-[#07060E] px-4 py-20">
        <div className="footer-card lg:w-5/12 relative bottom-32 bg-white rounded-3xl px-4 py-4 text-black font-bold mx-auto flex justify-around md:w-7/12">
            <div className='w-64'>
            ...
            <div className="footer-card-img">
                <img src="images/left ellipse.jpg" className='rounded-tl-3xl rounded-br-3xl relative bottom-12' alt="img" width={150} />
            </div>
        </div>
        <div className="flex justify-center mb-20">
        <button className='bg-gradient-to-r from-[#FFF500] to-[#00CCFF] mx-8 rounded-3xl text-xs text-black font-bold px-12 py-3'>SIGN UP</button>
        ...
        <div className="flex justify-around mt-8">
            ...
            <div className='text-xs text-[#FEFEFE66]'>JEC ACM, Jabalpur Engineering College, Jabalpur</div>
        </div>
        <div className="flex xl:justify-evenly text-white mt-4 md:justify-center">
            ...
            <div className='text-xs text-[#FEFEFE66]'>
                <a href="#" className='lg:mx-8 md:mx-2'>Privacy Policy</a>
                <a href="#" className='lg:mx-8 md:mx-2'>Terms of Use</a>
                <a href="#" className='lg:mx-8 md:mx-2'>© ACM-JEC 2022 - All rights reserved</a>
            </div>
        </div>
